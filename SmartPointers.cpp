...
int main(){
    ...
    //shared pointer maintains a reference count which tells how many objects are pointing to it...as soon as that reference count becomes zero thar is deleted
    //shared pointer has use count feature also that tells the reference count.
